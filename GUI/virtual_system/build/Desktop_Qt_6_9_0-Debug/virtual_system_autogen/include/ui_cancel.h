...
public:
    ...
    void setupUi(QWidget *Cancel)
    {
        ...
        Cancel->resize(800, 600);
        mainLayout = new QVBoxLayout(Cancel);
        mainLayout->setObjectName("mainLayout");
        scrollArea = new QScrollArea(Cancel);
        ...
        back_button = new QPushButton(Cancel);
...
"QPushButton:pressed { background-color: #3d8b40; }"));
    ...
    {
        back_button->setText(QCoreApplication::translate("Cancel", "Back", nullptr));
        (void)Cancel;
    } // retranslateUi
